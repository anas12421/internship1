	...
	<div id="main-wrapper">
        ...
        ***********************************-->
		<div class="nav-header mt-3">
			<a href="dashboard.php?id=<?=$user_id?>" class="brand-logo d-flex justify-content-center">
				<img class=" w-50" src="./asset/images/nc_logo.png" alt="">
						...
						<ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown header-profile">
								<a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
									...
									<img src="./asset/uploads/users/<?=$user_assoc['photo']?>" width="20" alt="" />
									<div class="header-info">
										<span class="text-black text-capitalize"><strong><?=$user_assoc['name']?></strong></span>
										<p class="fs-12 mb-0">
											<?=$user_assoc['role'] == 1 ? 'Comissioner' : ''?>
											<?=$user_assoc['role'] == 2 ? 'Voter Candidate' : ''?>
											<?=$user_assoc['role'] == 0 ? 'Voter' : ''?>
										</p>
									</div>
								</a>
								<div class="dropdown-menu dropdown-menu-right">
									<a href="user_profile.php" class="dropdown-item ai-icon">
		...
		<div class="deznav">
			<div class="deznav-scroll">
				...
				<ul class="metismenu" id="menu">
					<li><a class="" href="./dashboard.php?id=<?=$user_id?>">
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="./voter_list.php?id=<?=$user_id?>">Voters List</a></li>
							<li><a href="./voter_soft_delete.php?id=<?=$user_id?>">Trash Voter List</a></li>
						</ul>
					</li>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="./candidate_list.php?id=<?=$user_id?>">Candidates List</a></li>
						</ul>
					</li>
					<?php } ?>
				</ul>
