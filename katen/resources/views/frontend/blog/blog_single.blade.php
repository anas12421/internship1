				...
				<div class="col-lg-8">
						...
						<div class="post-bottom">
							<div class="row d-flex align-items-center">
								<div class="col-md-6 col-12 text-center text-md-start">
                                    ...
                                    <a href="#" class="tag text-capitalize me-1">#{{App\Models\Tag::find($tag)->name}}</a>
                                        {{-- <a href="" class="badge bg-danger text-capitalize"></a> --}}
                                    @endforeach
					...
					<div class="comments bordered padding-30 rounded">
						...
						<ul class="comments">
							...
							<li class="comment rounded">
								<div class="thumb">
									<img src="{{asset('frontend_asset')}}/images/other/comment-3.png" alt="John Doe" />
								</div>
								<div class="details">
