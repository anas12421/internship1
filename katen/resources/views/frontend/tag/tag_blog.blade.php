        ...
        <section class="page-header">
            <div class="container-xl">
                <div class="text-center">
                    <h1 class="mt-0 mb-2 text-capitalize">
                        @if (@$_GET['tag'])
                        {{App\Models\Tag::find(@$_GET['tag'])->name}}
                        @endif
                    </h1>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row gy-4">
                            ...
                            <h3>Search Results For '{{@$_GET['tag'] ? App\Models\Tag::find(@$_GET['tag'])->name : ''}}{{@$_GET['search_val'] ? @$_GET['search_val'] : ''}}'</h3>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="post post-grid rounded bordered">
                                    <div class="thumb top-rounded">
                                        <a href="{{route('category.view' , $blog->category_id)}}" class="category-badge position-absolute">{{$blog->rel_to_cat->name}}</a>
                                        <span class="post-format">
                                            <i class="icon-picture"></i>
                                        </span>
                                        <a href="{{route('blog_single' , $blog->slug)}}">
                                            <div class="inner">
                                                <img src="{{ asset('uploads/blogs') }}/{{$blog->photo}}"
                                                    alt="post-title" />
                                            </div>
                                        </a>
                                    </div>
