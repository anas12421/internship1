                ...
                <form action="{{route('blog.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="text" name="author" class="form-control" value="{{Auth::user()->name}}" id="">
                        ...
                        <div class="col-lg-12 mb-3">
                            ...
                            <textarea class="form-control" id="summernote" name="description" id="" cols="30"
                                rows="10"></textarea>
                            @error('description')
                            <div class="alert alert-danger mt-2">{{$message}}</div>
                            @enderror
                        ...
                        <div class="col-lg-12 mb-3">
                            ...
                            <textarea class="form-control" id="summernote2" name="auth_desp" id="" cols="30"
                                rows="10"></textarea>
                            @error('auth_desp')
                            <div class="alert alert-danger mt-2">{{$message}}</div>
                            @enderror
                        ...
                        <div class="col-lg-12 mb-3">
                            ...
                            <img src="" id="profile" width="300" alt="">
